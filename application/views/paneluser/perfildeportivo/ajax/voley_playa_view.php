...
<?php $this->load->helper('form');?>
    ...
    <div class="trow "
        ...
        <input type="text" name="txtPareja" id="txtPareja" class="wsize2" tabindex="2" value="<?=$info['pareja'] ?>" />
    </div>
    ...
    <div class="trow "
        <label class="label label-form" for="txtPosicion"><span class="required">*</span>Posicion</label>
        <input type="text" name="txtPosicion" id="txtPosicion" class="wsize2" tabindex="2" value="<?=$info['posicion'] ?>" />
    </div>
    <div class="trow "
        <label class="label label-form" for="txtGanancia"><span class="required">*</span>Ganancias Totales en U$S</label>
