...
<?php $this->load->helper('form');?>
    ...
    <div class="trow">
        <label class="label label-form" for="chkFutIzquierda"><span class="required">*</span>Pierna h&aacute;bil</label>
       
            <label class="label" for="chkFutIzquierda">
                <input type="radio" name="chkFutPierna" id="chkFutIzquierda" class="wsize2" tabindex="2" <?=getval($info['pierna_habil'], 'checked', "i")?> />Izquierda
            </label>
            <label class="label" for="chkFutDerecha">
                <input type="radio" name="chkFutPierna" id="chkFutDerecha" class="wsize2" tabindex="2" <?=getval($info['pierna_habil'], 'checked', "d")?> /> Derecha
            </label>
    </div>
