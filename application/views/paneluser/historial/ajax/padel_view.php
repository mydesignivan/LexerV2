    ...
    <div id="div_sports">
        ...
        ?>
            <div class="chistorial">
                ...
                <div class="trow">
                    <label class="label label-form" for="txtTorneo"><span class="required">*</span>Torneo</label>
                    <input type="text" name="txtTorneo" class="wsize2" tabindex="2" value="<?=$hist_row['torneo'] ?>" />
                </div>
                <!-- ========== CATEGORIA  =========== -->
                <div class="trow">
                ...
                <div class="trow">
                    <label class="label label-form" for="cboModalidad"><span class="required">*</span>Modalidad</label>
                        <?=form_dropdown('cboModalidad', $hist_row['cboModalidad'], $hist_row['modalidad'], ' tabindex="1"');?>
                </div>
                    ...
                    <table id="tblDatos" cellpadding="0" cellspacing="0">
                        <tbody>
                            ...
                            <tr class="fixed" >
                                ...
                                <td class="cell3" ><input type="text" value="<?=$hist_row['saque_drive']?>" name="txtSaqueDrive" ></td>
                                <td class="cell4" ><input type="text" value="<?=$hist_row['saque_reves']?>" name="txtSaqueReves" ></td>
                                <td class="cell5" ></td>
                                <td class="cell6" ></td>
                                <td class="cell7" ></td>
                                <td class="cell8" ></td>
                            ...
                            <tr class="fixed" >
                                ...
                                <td class="cell3" ><input type="text" value="<?=$hist_row['volea_drive']?>" name="txtVoleaDrive" ></td>
                                <td class="cell4" ><input type="text" value="<?=$hist_row['volea_reves']?>" name="txtVoleaReves" ></td>
                                <td class="cell5" ></td>
                                <td class="cell6" ></td>
                                <td class="cell7" ></td>
                                <td class="cell8" ></td>
                            ...
                            <tr class="fixed" >
                                ...
                                <td class="cell3" ><input type="text" value="<?=$hist_row['bandeja_drive']?>" name="txtBandejaDrive" ></td>
                                <td class="cell4" ><input type="text" value="<?=$hist_row['bandeja_reves']?>" name="txtBandejaReves" ></td>
                                <td class="cell5" ></td>
                                <td class="cell6" ></td>
                                <td class="cell7" ></td>
                                <td class="cell8" ></td>
                            ...
                            <tr class="fixed" >
                                ...
                                <td class="cell3" ><input type="text" value="<?=$hist_row['remates_drive']?>" name="txtRematesDrive" ></td>
                                <td class="cell4" ><input type="text" value="<?=$hist_row['remates_reves']?>" name="txtRematesReves" ></td>
                                <td class="cell5" ></td>
                                <td class="cell6" ></td>
                                <td class="cell7" ></td>
                                <td class="cell8" ></td>
                            ...
                            <tr class="fixed" >
                                ...
                                <td class="cell3" ><input type="text" value="<?=$hist_row['out_drive']?>" name="txtOutDrive" ></td>
                                <td class="cell4" ><input type="text" value="<?=$hist_row['out_reves']?>" name="txtOutReves" ></td>
                                <td class="cell5" ></td>
                                <td class="cell6" ></td>
                                <td class="cell7" ></td>
                                <td class="cell8" ></td>
                            ...
                            <tr class="fixed" >
                                ...
                                <td class="cell3" ><input type="text" value="<?=$hist_row['dejada_drive']?>" name="txtDejadaDrive" ></td>
                                <td class="cell4" ><input type="text" value="<?=$hist_row['dejada_reves']?>" name="txtDejadaReves" ></td>
                                <td class="cell5" ></td>
                                <td class="cell6" ></td>
                                <td class="cell7" ></td>
                                <td class="cell8" ></td>
                            ...
                            <tr class="fixed" >
                                ...
                                <td class="cell3" ><input type="text" value="<?=$hist_row['bajada_drive']?>" name="txtBajadaDrive" ></td>
                                <td class="cell4" ><input type="text" value="<?=$hist_row['bajada_reves']?>" name="txtBajadaReves" ></td>
                                <td class="cell5" ></td>
                                <td class="cell6" ></td>
                                <td class="cell7" ></td>
                                <td class="cell8" ></td>
                           ...
                           <tr class="fixed" >
                                ...
                                <td class="cell3" ><input type="text" value="<?=$hist_row['globo_drive']?>" name="txtGloboDrive" ></td>
                                <td class="cell4" ><input type="text" value="<?=$hist_row['globo_reves']?>" name="txtGloboReves" ></td>
                                <td class="cell5" ></td>
                                <td class="cell6" ></td>
                                <td class="cell7" ></td>
                                <td class="cell8" ></td>
                            ...
                            <tr class="fixed" >
                                ...
                                <td class="cell3" ><input type="text" value="<?=$hist_row['resto_drive']?>" name="txtRestoDrive" ></td>
                                <td class="cell4" ><input type="text" value="<?=$hist_row['resto_reves']?>" name="txtRestoReves" ></td>
                                <td class="cell5" ></td>
                                <td class="cell6" ></td>
                                <td class="cell7" ></td>
                                <td class="cell8" ></td>
                            ...
                            <tr class="fixed" >
                                ...
                                <td class="cell3" ><input type="text" value="<?=$hist_row['fondo_drive']?>" name="txtFondoDrive" ></td>
                                <td class="cell4" ><input type="text" value="<?=$hist_row['fondo_reves']?>" name="txtFondoReves" ></td>
                                <td class="cell5" ></td>
                                <td class="cell6" ></td>
                                <td class="cell7" ></td>
                                <td class="cell8" ></td>
                            ...
                            <tr class="fixed" >
                                ...
                                <td class="cell3" ><input type="text" value="<?=$hist_row['error_forzado_drive']?>" name="txtForzadoDrive" ></td>
                                <td class="cell4" ><input type="text" value="<?=$hist_row['error_forzado_reves']?>" name="txtForzadoReves" ></td>
                                <td class="cell5" ></td>
                                <td class="cell6" ></td>
                                <td class="cell7" ></td>
                                <td class="cell8" ></td>
                            ...
                            <tr class="fixed" >
                                ...
                                <td class="cell3" ><input type="text" value="<?=$hist_row['error_no_forzado_drive']?>" name="txtNoForzadoDrive" ></td>
                                <td class="cell4" ><input type="text" value="<?=$hist_row['error_no_forzado_reves']?>" name="txtNoForzadoReves" ></td>
                                <td class="cell5" ></td>
                                <td class="cell6" ></td>
                                <td class="cell7" ></td>
                                <td class="cell8" ></td>
                            ...
                            <tr class="fixed" >
                                ...
                                <td class="cell3" ><input type="text" value="<?=$hist_row['doble_falta_drive']?>" name="txtDobleFaltaDrive" ></td>
                                <td class="cell4" ><input type="text" value="<?=$hist_row['doble_falta_reves']?>" name="txtDobleFaltaReves" ></td>
                                <td class="cell5" ></td>
                                <td class="cell6" ></td>
                                <td class="cell7" ></td>
                                <td class="cell8" ></td>
                ...
                <div id="contEficiencia" class="trow tbl">
                    ...
                    <table cellpadding="0" cellspacing="0">
                            ...
                            <tr class="fixed" >
                                ...
                                <td class="cell2">
                                    <input type="text" value="<?=$hist_row['decisivos_cantidad']?>" name="txtDecisivosCantidad" >
                                </td>
                                <td class="cell2">
                                    <input type="text" value="<?=$hist_row['decisivos_total']?>" name="txtDecisivosTotal" >
                                </td>
                                <td class="cell4">
                           ...
                           <tr class="fixed" >
                                ...
                                <td class="cell2">
                                    <input type="text" value="<?=$hist_row['set_cantidad']?>" name="txtSetCantidad" >
                                </td>
                                <td class="cell2">
                                    <input type="text" value="<?=$hist_row['set_total']?>" name="txtSetTotal" >
                                </td>
                                <td class="cell4">
                                    <label class="label "></label>
                                </td>
                            ...
                            <tr class="fixed" >
                                ...
                                <td class="cell2">
                                    <input type="text" value="<?=$hist_row['partido_cantidad']?>" name="txtPartidoCantidad" >
                                </td>
                                <td class="cell2">
                                    <input type="text" value="<?=$hist_row['partido_total']?>" name="txtPartidoTotal" >
                                </td>
                                <td class="cell4">
                            ...
                            <tr class="fixed" >
                                ...
                                <td class="cell2">
                                    <input type="text" value="<?=$hist_row['break_cantidad']?>" name="txtBreakCantidad" >
                                </td>
                                <td class="cell2">
                                    <input type="text" value="<?=$hist_row['break_total']?>" name="txtBreakTotal" >
                                </td>
                                <td class="cell4">
