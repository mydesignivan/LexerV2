...
?>
        ...
        <div class="fleft">
            <div class="fleft">
                ...
                <button id="btnUpload2" type="button" onclick="PersonalPreprData.upload();" class="float-left">Subir</button>
  ...
  <?php /*  <div class="trow">
    ...
    <div class="trow">
        ...
        <?=form_dropdown('cboCurrentCountry', $comboCountry, $info['current_country'], 'id="cboCurrentCountry" tabindex="10" onchange="PersonalPreprData.get_combo_states(this, \'#contCurrentStates\')"');?>
    ...
    <div class="trow">
        ...
        <?php $comboCountry[''] = "&nbsp;";?>
        <?=form_dropdown('cboOriginCountry', $comboCountry, $info['origin_country'], 'id="cboOriginCountry" tabindex="14" onchange="PersonalPreprData.get_combo_states(this, \'#contOriginStates\')"');?>
        <img src="images/ajax-loader.gif" alt="Loading" width="16" height="16" class="jq-loader hide" />
    </div>
    <!-- ========== PROVINCIA ORIGEN =========== -->
