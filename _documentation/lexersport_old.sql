...
--
-- Servidor: localhost
-- Tiempo de generación: 30-07-2010 a las 17:50:39
...
('78f5c32758978f37dc65b3c97d950bc7', '0.0.0.0', 'Mozilla/5.0 (X11; U; Linux i686; es-AR; rv:1.9.1.6', 1268147424, ''),
('3c1fe843ba038d68d3e8a9090111785c', '0.0.0.0', 'Mozilla/5.0 (X11; U; Linux i686; es-AR; rv:1.9.1.6', 1268347700, ''),
('8938f22fc511e8aaeef16391328c218e', '127.0.0.1', 'Mozilla/5.0 (X11; U; Linux i686; es-AR; rv:1.9.1.9', 1280263028, '');
...
CREATE TABLE IF NOT EXISTS `images` (
  `codimage` int(11) NOT NULL AUTO_INCREMENT,
  `coduser` int(11) DEFAULT NULL,
  `filename` varchar(255) CHARACTER SET utf8 DEFAULT NULL,
  `filesize` double DEFAULT NULL COMMENT 'Expresado byte',
  PRIMARY KEY (`codimage`)
...
INSERT INTO `images` (`codimage`, `coduser`, `filename`, `filesize`) VALUES
(8, 22, '2800452127_865d013225.jpg', NULL),
(9, 22, '3369408747_83095f29a6.jpg', NULL),
(10, 22, '3465833837_17567e0d0d.jpg', NULL),
(11, 22, '3687873529_f9fdf420c9.jpg', NULL),
(12, 22, '3926997014_81d65b265d.jpg', NULL),
(13, 22, '3989857323_156d28d272.jpg', NULL),
(14, 22, '4086231325_7d997a047d.jpg', NULL);

-- --------------------------------------------------------

--
-- Estructura de tabla para la tabla `images_curri`
--

DROP TABLE IF EXISTS `images_curri`;
CREATE TABLE IF NOT EXISTS `images_curri` (
  `codimage` int(11) NOT NULL AUTO_INCREMENT,
  `coduser` int(11) DEFAULT NULL,
  `filename` varchar(255) COLLATE utf8_spanish_ci DEFAULT NULL,
  `filesize` double DEFAULT NULL COMMENT 'Expresado en byte',
  PRIMARY KEY (`codimage`)
) ENGINE=MyISAM  DEFAULT CHARSET=utf8 COLLATE=utf8_spanish_ci AUTO_INCREMENT=18 ;

--
-- Volcar la base de datos para la tabla `images_curri`
--
...
--
-- Estructura de tabla para la tabla `list_best_shot`
--

DROP TABLE IF EXISTS `list_best_shot`;
CREATE TABLE IF NOT EXISTS `list_best_shot` (
  `code` int(11) NOT NULL AUTO_INCREMENT,
  `codsport` int(11) DEFAULT NULL,
  `name` varchar(255) COLLATE utf8_spanish_ci DEFAULT NULL,
  PRIMARY KEY (`code`)
) ENGINE=MyISAM  DEFAULT CHARSET=utf8 COLLATE=utf8_spanish_ci COMMENT='Mejor Golpe' AUTO_INCREMENT=28 ;

--
-- Volcar la base de datos para la tabla `list_best_shot`
--

INSERT INTO `list_best_shot` (`code`, `codsport`, `name`) VALUES
(1, 6, 'Aire'),
(2, 6, 'Conversiones'),
(3, 6, 'Drop'),
(5, 10, 'Pegada Moderna'),
...
(13, 23, 'Volea Revés'),
(14, 23, 'Smash'),
(15, 23, 'Pared de Derecha'),
(16, 23, 'Pared de Revés'),
(17, 23, 'Bandeja'),
(18, 23, 'Saque');
...
--
-- Estructura de tabla para la tabla `list_capacity`
--

DROP TABLE IF EXISTS `list_capacity`;
CREATE TABLE IF NOT EXISTS `list_capacity` (
  `codcapacity` int(11) NOT NULL AUTO_INCREMENT,
  `name` varchar(255) COLLATE utf8_spanish_ci DEFAULT NULL,
  PRIMARY KEY (`codcapacity`)
) ENGINE=MyISAM  DEFAULT CHARSET=utf8 COLLATE=utf8_spanish_ci AUTO_INCREMENT=9 ;

--
-- Volcar la base de datos para la tabla `list_capacity`
--

INSERT INTO `list_capacity` (`codcapacity`, `name`) VALUES
(1, 'Resistencia'),
(2, 'Fuerza'),
(3, 'Velocidad'),
(4, 'Potencia'),
...
CREATE TABLE IF NOT EXISTS `list_category` (
  `codcategory` int(11) NOT NULL AUTO_INCREMENT,
  `codsport` int(11) DEFAULT NULL,
  `name` varchar(255) COLLATE utf8_spanish_ci DEFAULT NULL,
  `level` int(11) DEFAULT NULL COMMENT '1=Profesional, 2=Aficionado,3=Amateur',
  PRIMARY KEY (`codcategory`)
) ENGINE=MyISAM  DEFAULT CHARSET=utf8 COLLATE=utf8_spanish_ci AUTO_INCREMENT=54 ;

--
-- Volcar la base de datos para la tabla `list_category`
--

INSERT INTO `list_category` (`codcategory`, `codsport`, `name`, `level`) VALUES
(1, 15, 'Principiante', NULL),
(2, 15, 'Infantiles', NULL),
(3, 15, 'Cadetes', NULL),
(4, 15, 'Sub-23', NULL),
(5, 15, 'Elite', NULL),
(6, 15, 'Elite UCI', NULL),
...
(11, 15, 'Master E', NULL),
(12, 15, 'Junior', NULL),
(13, 16, 'Mínimo o paja - menos de 47.7 kg', 1),
(14, 16, 'Minimosca -  hasta 49 kg', 1),
(15, 16, 'Mosca  hasta 50,8 kg', 1),
(16, 16, 'Supermosca  hasta 52,2 kg', 1),
(17, 16, 'Gallo  hasta 53,5 kg', 1),
(18, 16, 'Supergallo  hasta 55,3 kg ', 1),
(19, 16, 'Pluma  hasta 57,2 kg ', 1),
(20, 16, 'Superpluma o ligero junior  hasta 59 kg ', 1),
(21, 16, 'Ligero  hasta 61,2 kg ', 1),
(22, 16, 'Superligero o welter junior  hasta 63,5 kg', 1),
(23, 16, 'Welter o medio mediano- hasta 66,7 kg ', 1),
(24, 16, 'Superwelter o medio juniors  hasta 69,9 kg', 1),
(25, 16, 'Mediano  hasta 72,6 kg ', 1),
(26, 16, 'Supermediano  hasta 76,2 kg ', 1),
(27, 16, 'Mediopesado  hasta 79,4 kg ', 1),
(28, 16, 'Crucero  hasta 90,72 kg. Solo para varones', 1),
(29, 16, 'Peso pesado Varones: +90,72 kg ', 1),
(30, 16, 'Peso pesado Mujeres: +79,37 kg', 1),
(31, 16, 'Peso Mosca Ligero (48 kg hombre, 46 kg mujeres)', 2),
(32, 16, 'Peso Mosca (51 kg hombres , 48 kg mujeres)', 2),
(33, 16, 'Peso Gallo (54 kg hombres , 51 kg mujeres)', 2),
(34, 16, 'Peso Pluma  (57 kg hombres , 54 kg mujeres)', 2),
(35, 16, 'Peso Ligero  (60 kg hombres , 48 kg mujeres)', 2),
(36, 16, 'Peso Welter Ligero(64 kg hombres , 60 kg mujeres)', 2),
(37, 16, 'Peso Welter  (69 kg hombres , 64 kg mujeres)', 2),
(38, 16, 'Peso Medio  (75 kg hombres , 69 kg mujeres)', 2),
(39, 16, 'Peso Semi Pesado  (81 kg hombres , 75 kg mujeres)', 2),
(40, 16, 'Peso Pesado  (91 kg hombres , 81 kg mujeres)', 2),
(41, 16, 'Peso super pesado (mas 91 kg hombres , mas 81 kg mujeres)', 2),
(42, 16, 'Paja (hasta 41 kg)', 3),
(43, 16, 'Mosca - Ligero (41 hombres  -48 kg mujeres)', 3),
(44, 16, 'Mosca (48 hombres  - 51 kg mujeres)', 3),
(45, 16, 'Gallo (51 hombres  - 54 kg mujeres)', 3),
(46, 16, 'Pluma (54  hombres - 57 kg mujeres)', 3),
(47, 16, 'Ligero (57 hombres - 60 kg mujeres)', 3),
(48, 16, 'Súper - Ligero (60 hombres - 64 kg mujeres)', 3),
(49, 16, 'Welter (64 hombres - 69 kg mujeres)', 3),
(50, 16, 'Medio (69 hombres - 75 kg mujeres)', 3),
(51, 16, 'Semi - Pesado (75 kg hombres - 81 kg mujeres)', 3),
(52, 16, 'Pesado (81 kg hombres - 91 kg mujeres)', 3),
(53, 16, 'Súper - Pesado (más de 91 kg mujeres)', 3);

-- --------------------------------------------------------

--
-- Estructura de tabla para la tabla `list_companies_items`
--

DROP TABLE IF EXISTS `list_companies_items`;
CREATE TABLE IF NOT EXISTS `list_companies_items` (
  `coditem` int(11) NOT NULL AUTO_INCREMENT,
  `name` char(100) COLLATE utf8_spanish_ci DEFAULT NULL,
  PRIMARY KEY (`coditem`)
) ENGINE=MyISAM  DEFAULT CHARSET=utf8 COLLATE=utf8_spanish_ci AUTO_INCREMENT=39 ;

--
-- Volcar la base de datos para la tabla `list_companies_items`
--

INSERT INTO `list_companies_items` (`coditem`, `name`) VALUES
...
CREATE TABLE IF NOT EXISTS `list_country` (
  `codcountry` int(11) NOT NULL AUTO_INCREMENT,
  `name` varchar(255) COLLATE utf8_spanish_ci DEFAULT NULL,
...
INSERT INTO `list_country` (`codcountry`, `name`) VALUES
(1, 'Afganistán'),
(2, 'Albania'),
(3, 'Alemania'),
(4, 'American Samoa'),
...
--
-- Estructura de tabla para la tabla `list_discipline`
--

DROP TABLE IF EXISTS `list_discipline`;
CREATE TABLE IF NOT EXISTS `list_discipline` (
  `coddiscipline` int(11) NOT NULL AUTO_INCREMENT,
  `name` varchar(255) COLLATE utf8_spanish_ci DEFAULT NULL,
  PRIMARY KEY (`coddiscipline`)
) ENGINE=MyISAM DEFAULT CHARSET=utf8 COLLATE=utf8_spanish_ci COMMENT='Disciplina' AUTO_INCREMENT=1 ;

--
-- Volcar la base de datos para la tabla `list_discipline`
--
...
--
-- Estructura de tabla para la tabla `list_greater_ability`
--

DROP TABLE IF EXISTS `list_greater_ability`;
CREATE TABLE IF NOT EXISTS `list_greater_ability` (
  `codability` int(11) NOT NULL AUTO_INCREMENT,
  `codsport` int(11) DEFAULT NULL,
  `name` varchar(255) COLLATE utf8_spanish_ci DEFAULT NULL,
  PRIMARY KEY (`codability`)
) ENGINE=MyISAM  DEFAULT CHARSET=utf8 COLLATE=utf8_spanish_ci COMMENT='Mayor Habilidad' AUTO_INCREMENT=6 ;

--
-- Volcar la base de datos para la tabla `list_greater_ability`
--

INSERT INTO `list_greater_ability` (`codability`, `codsport`, `name`) VALUES
(1, 7, 'Ataque'),
(2, 7, 'Defensa'),
(3, 7, 'Pitcheo'),
(4, 7, 'Recursos'),
...
--
-- Volcar la base de datos para la tabla `list_languages`
--

INSERT INTO `list_languages` (`codlang`, `name`) VALUES
(1, 'Afrikaans'),
(2, 'Albanés'),
(3, 'Alemán'),
(4, 'Amharico'),
...
--
-- Estructura de tabla para la tabla `list_lesions`
--

DROP TABLE IF EXISTS `list_lesions`;
CREATE TABLE IF NOT EXISTS `list_lesions` (
  `codlesion` int(11) NOT NULL AUTO_INCREMENT,
  `name` varchar(255) COLLATE utf8_spanish_ci DEFAULT NULL,
  PRIMARY KEY (`codlesion`)
) ENGINE=MyISAM  DEFAULT CHARSET=utf8 COLLATE=utf8_spanish_ci AUTO_INCREMENT=47 ;

--
-- Volcar la base de datos para la tabla `list_lesions`
--

INSERT INTO `list_lesions` (`codlesion`, `name`) VALUES
(2, 'Tennis Elbow o Codo de Tenista'),
(3, 'Fractura de Húmero'),
(4, 'Fractura de Costilla'),
(5, 'Fractura de Clavícula'),
(6, 'Fractura de Omóplato'),
(7, 'Fractura de Escafoides'),
(8, 'Fractura de Metacarpiano'),
(9, 'Fractura de Falange'),
(10, 'Fractura de Carpo'),
(11, 'Fractura de Cúbito'),
(12, 'Fractura de Radio'),
(13, 'Fractura de Vértebra'),
(14, 'Fractura de Hueso Ilíaco'),
(15, 'Fractura de Fémur'),
(16, 'Fractura de Tibia'),
(17, 'Fractura de Peroné'),
(18, 'Fractura de Tibia y Peroné'),
(19, 'Fracturá de Rótula'),
(20, 'Fractura de Astrágalo'),
(21, 'Fractura de Calcáneo'),
(22, 'Fractura de Cuboides'),
(23, 'Fractura de Cuña'),
(24, 'Fractura de Tarso'),
(25, 'Fractura de Metatarsiano'),
(26, 'Rotura del Manguito Rotador'),
(27, 'Capsulitis Adhesiva u Hombro Congelado'),
(28, 'Rotura de Ligamento Cruzado Anterior'),
(29, 'Rotura de Ligamento Cruzado Posterior'),
(30, 'Rotura de Ligamento Lateral Interno y <br>Rotura de Ligamento Lateral Externo'),
(31, 'Reemplazo de Rodilla'),
(32, 'Rotura de Menisco Externo'),
(33, 'Rotura de Menisco Interno'),
(34, 'Rotura de Tendón Rotuliano'),
(35, 'Hernia de Disco');

-- --------------------------------------------------------

--
-- Estructura de tabla para la tabla `list_modality`
--

DROP TABLE IF EXISTS `list_modality`;
CREATE TABLE IF NOT EXISTS `list_modality` (
  `codmod` int(11) NOT NULL AUTO_INCREMENT,
  `codsport` int(11) DEFAULT NULL,
  `name` varchar(255) COLLATE utf8_spanish_ci DEFAULT NULL,
  PRIMARY KEY (`codmod`)
) ENGINE=MyISAM  DEFAULT CHARSET=utf8 COLLATE=utf8_spanish_ci COMMENT='Modalidad' AUTO_INCREMENT=47 ;

--
-- Volcar la base de datos para la tabla `list_modality`
--

INSERT INTO `list_modality` (`codmod`, `codsport`, `name`) VALUES
(1, 8, 'Individuales'),
(2, 8, 'Dobles'),
(3, 8, 'Ambas'),
(4, 9, 'Individuales'),
...
(7, 18, 'Formula 1'),
(8, 18, 'GP 2 Series'),
(9, 18, 'Fórmula 3 Sudam'),
(10, 18, '500 de Indianápolis'),
(11, 18, 'Rally Sudamericano'),
(12, 18, 'Rally Cross Cuontry'),
(13, 18, 'Rally Dakar'),
(14, 18, 'Rally por las Pampas'),
(15, 18, 'Stock Car V8 Brasil'),
(16, 18, 'Midget'),
(17, 18, 'TC 2000'),
(18, 18, 'TC 4000'),
(19, 18, 'TC Pista'),
...
(32, 19, 'Quads'),
(33, 19, 'Supermotars'),
(34, 19, 'Streetbike Freestyle'),
(35, 19, 'Speedway'),
(36, 24, 'Aguas Abiertas'),
(37, 24, 'Braza'),
(38, 24, 'Crol'),
(39, 24, 'Espalda'),
(40, 24, 'Mariposa'),
(41, 25, 'Boulder A vista'),
(42, 25, 'Boulder Trabajada'),
(43, 25, 'Vía A vista'),
(44, 25, 'Vía Trabajada'),
(45, 25, ' Vía y Boulder A vista'),
(46, 25, ' Vía y Boulder Trabajada');

-- --------------------------------------------------------

--
-- Estructura de tabla para la tabla `list_operations`
--

DROP TABLE IF EXISTS `list_operations`;
CREATE TABLE IF NOT EXISTS `list_operations` (
  `codope` int(11) NOT NULL AUTO_INCREMENT,
  `name` varchar(255) COLLATE utf8_spanish_ci DEFAULT NULL,
  PRIMARY KEY (`codope`)
) ENGINE=MyISAM  DEFAULT CHARSET=utf8 COLLATE=utf8_spanish_ci ROW_FORMAT=DYNAMIC AUTO_INCREMENT=45 ;

--
-- Volcar la base de datos para la tabla `list_operations`
--

INSERT INTO `list_operations` (`codope`, `name`) VALUES
(1, 'Calcificaciones'),
(2, 'Desgarro Muscular'),
(3, 'Dislocación A-C'),
(4, 'Dislocación de Cadera'),
(5, 'Dislocación de Columna'),
(6, 'Dislocación de Falanges'),
(7, 'Dislocación de Hombro'),
(8, 'Dislocación de Rótula'),
(9, 'Fractura de Acromion'),
(10, 'Fractura de Antebrazo'),
(11, 'Fractura de Bennett y Rolando'),
(12, 'Fractura de Cadera'),
(13, 'Fractura de Clavícula'),
(14, 'Fractura de Codo'),
(15, 'Fractura de Columna'),
(16, 'Fractura de Costilla'),
(17, 'Fractura de Cráneo'),
(18, 'Fractura de Escafoides'),
(19, 'Fractura de Falanges'),
(20, 'Fractura de Fémur'),
(21, 'Fractura de Húmero'),
(22, 'Fractura de Muñeca'),
(23, 'Fractura de Pelvis'),
(24, 'Fractura de Quinto Metatarsiano'),
(25, 'Fractura de Rótula'),
(26, 'Fractura de Tibia y Peroné'),
(27, 'Fractura de Tobillo'),
(28, 'Hernia Discal'),
(29, 'Luxación A-C'),
(30, 'Luxación de Cadera'),
(31, 'Luxación de Codo'),
(32, 'Luxación de Hombro'),
(33, 'Pubalgia'),
(34, 'Rotura Cartilaginosa'),
(35, 'Rotura de Articulaciones'),
(36, 'Rotura de Ligamento Cruzado Anterior (LCA)'),
(37, 'Rotura de Ligamento Cruzado Posterior (LCP)'),
(38, 'Rotura de Ligamento Lateral Externo (LLE)'),
(39, 'Rotura de Ligamento Lateral Interno (LLI)'),
(40, 'Rotura de Ligamentos'),
(41, 'Rotura de Manguito Rotador'),
(42, 'Rotura de Menisco'),
(43, 'Rotura de Tendón de Aquiles'),
(44, 'Rotura Muscular');

-- --------------------------------------------------------

--
-- Estructura de tabla para la tabla `list_position`
--
...
--
-- Volcar la base de datos para la tabla `list_position`
--

INSERT INTO `list_position` (`codposition`, `codsport`, `name`) VALUES
(1, 1, 'Arquero'),
(2, 1, 'Defensor'),
(3, 1, 'Volante'),
(4, 1, 'Delantero'),
...
(9, 2, 'Right Tackle (RT)'),
(10, 2, 'Left Tackle (LT)'),
(11, 2, 'Running Back (RB)'),
(12, 2, 'Wide Recievers (WR)'),
(13, 2, 'Defensive Tackles (DT)'),
(14, 2, 'Defensive Ends (DE)'),
(15, 2, 'Linebackers (LB)'),
(16, 2, 'Cornerback (CB)'),
(17, 2, 'Strong Safety (SS)'),
(18, 2, 'Free Safety (FS)'),
(19, 2, 'Special Team'),
(20, 3, 'Arquero'),
(21, 3, 'Cierre'),
...
(68, 13, 'Arquero'),
(69, 13, 'Central'),
(70, 13, 'Extremo Derecho'),
(71, 13, 'Extremo Izquierdo'),
(72, 13, 'Lateral Derecho'),
(73, 13, 'Lateral Izquierdo'),
(74, 13, 'Pivote'),
(75, 13, 'Universal'),
(76, 20, 'Base'),
(77, 20, 'Alero'),
...
--
-- Estructura de tabla para la tabla `list_position_advanced`
--

DROP TABLE IF EXISTS `list_position_advanced`;
CREATE TABLE IF NOT EXISTS `list_position_advanced` (
  `codposition` int(11) NOT NULL AUTO_INCREMENT,
  `codsport` int(11) DEFAULT NULL,
  `name` varchar(255) COLLATE utf8_spanish_ci DEFAULT NULL,
  PRIMARY KEY (`codposition`)
...
--
-- Volcar la base de datos para la tabla `list_position_advanced`
--

INSERT INTO `list_position_advanced` (`codposition`, `codsport`, `name`) VALUES
(1, 1, 'Arquero'),
(2, 1, 'Lateral Izquierdo'),
(3, 1, 'Lateral Derecho'),
(4, 1, 'Central'),
(5, 1, 'Líbero'),
(6, 1, 'Volante Central'),
(7, 1, 'Volante Izquierdo'),
(8, 1, 'Volante Derecho'),
(9, 1, 'Enganche'),
(10, 1, 'Delantero Central'),
(11, 1, 'Wing');

-- --------------------------------------------------------

--
-- Estructura de tabla para la tabla `list_provinces`
--

DROP TABLE IF EXISTS `list_provinces`;
CREATE TABLE IF NOT EXISTS `list_provinces` (
  `codprovince` int(11) NOT NULL AUTO_INCREMENT,
...
--
-- Volcar la base de datos para la tabla `list_provinces`
--

INSERT INTO `list_provinces` (`codprovince`, `codcountry`, `name`) VALUES
(1, 1, 'Badakhshan'),
(2, 1, 'Badghis'),
(3, 1, 'Baghlan'),
(4, 1, 'Balkh'),
...
--
-- Estructura de tabla para la tabla `list_selected`
--

DROP TABLE IF EXISTS `list_selected`;
CREATE TABLE IF NOT EXISTS `list_selected` (
  `codsel` int(11) NOT NULL AUTO_INCREMENT,
  `codsport` int(11) DEFAULT NULL,
  `name` varchar(255) COLLATE utf8_spanish_ci DEFAULT NULL,
  PRIMARY KEY (`codsel`)
) ENGINE=MyISAM  DEFAULT CHARSET=utf8 COLLATE=utf8_spanish_ci COMMENT='Seleccionado' AUTO_INCREMENT=20 ;

--
-- Volcar la base de datos para la tabla `list_selected`
--

INSERT INTO `list_selected` (`codsel`, `codsport`, `name`) VALUES
(1, 7, 'Nacional Mayor'),
(2, 7, 'Nacional Juvenil'),
(3, 7, 'Regional'),
(4, 8, 'Nacional Mayor'),
(5, 8, 'Nacional Juvenil'),
(6, 8, 'Regional'),
(7, 8, 'Sudamericano'),
(8, 8, 'Internacional'),
(9, 10, 'Nacional Mayor'),
(10, 10, 'Nacional Juvenil'),
(11, 10, 'Provincial'),
(12, 10, 'Regional'),
(13, 10, 'Local'),
(14, 13, 'Mayor'),
(15, 13, 'Juvenil'),
(16, 13, 'Regional'),
(17, 24, 'Nacional Mayor'),
(18, 24, 'Nacional Juvenil'),
(19, 24, 'Regional');
...
CREATE TABLE IF NOT EXISTS `list_sports` (
  `codsport` int(11) NOT NULL AUTO_INCREMENT,
  `name` varchar(255) COLLATE utf8_spanish_ci DEFAULT NULL,
  `form` char(50) COLLATE utf8_spanish_ci DEFAULT NULL,
  PRIMARY KEY (`codsport`)
...
INSERT INTO `list_sports` (`codsport`, `name`, `form`) VALUES
(7, 'Softbol', NULL),
(6, 'Rugby', NULL),
(5, 'Voley de Playa', NULL),
(4, 'Voley', NULL),
(3, 'Futbol de Salón', NULL),
(2, 'Futbol Americano', NULL),
(1, 'Futbol', NULL),
(8, 'Tenis', NULL),
(9, 'Tenis de Mesa', NULL),
(10, 'Hockey sobre Césped', NULL),
(11, 'Hockey sobre Hielo', NULL),
(12, 'Hockey sobre Patines', NULL),
(13, 'Handbal', NULL),
(14, 'Golf', NULL),
(15, 'Ciclismo', NULL),
(16, 'Boxeo', NULL),
(17, 'Atletismo', NULL),
(18, 'Automovilismo', NULL),
(19, 'Motociclismo', NULL),
(20, 'Basket', NULL),
(21, 'Beisbol', NULL),
(22, 'Waterpolo', NULL),
(23, 'Pádle', NULL),
(24, 'Natación', NULL),
(25, 'Escalada Deportiva', NULL);

-- --------------------------------------------------------

--
-- Estructura de tabla para la tabla `list_test`
--

DROP TABLE IF EXISTS `list_test`;
CREATE TABLE IF NOT EXISTS `list_test` (
  `codtest` int(11) NOT NULL AUTO_INCREMENT,
  `codcapacity` int(11) DEFAULT NULL,
  `name` varchar(255) COLLATE utf8_spanish_ci DEFAULT NULL,
...
--
-- Volcar la base de datos para la tabla `list_test`
--

INSERT INTO `list_test` (`codtest`, `codcapacity`, `name`, `level`) VALUES
(1, 1, '400 Mts. Llanos', 1),
(2, 1, '400 Mts. Vallas', 1),
(3, 1, 'Relevo 4 x 400', 1),
(4, 1, '800 Mts. Llanos', 1),
(5, 1, '1.000 Mts. Llanos', 1),
(6, 1, '1500 Mts. Llanos', 1),
(7, 1, '2000 Mts. C/Obst.', 1),
(8, 1, '3.000 Mts. Llanos', 1),
(9, 1, '3.000 Mts. c/Obst.', 1),
(10, 1, '5.000 Mts. Llanos', 1),
(11, 1, '10.000 Mts. Llanos', 1),
(12, 1, 'œ Maratón', 1),
(13, 1, 'Maratón', 1),
(14, 1, 'Duatlón', 1),
(15, 1, 'Triatlón', 1),
...
(18, 1, 'Octatlón', 1),
(19, 1, 'Marcha', 1),
(20, 1, 'Yo-yo Test Nivel 1', 1),
(21, 1, 'Yo-yo Test Nivel 2', 1),
(22, 1, 'Yo-yo Test Nivel 3', 1),
(23, 1, '40ŽŽ (Anaeróbico)', 1),
(24, 1, 'Test de Cooper', 1),
(25, 1, 'Test del Km', 1),
(26, 1, 'Test de Ruffier', 1),
(27, 2, 'Test Ley de Hill (1RM)', 0),
(28, 2, 'Cuádriceps', 1),
(29, 2, 'Isquiotibiales', 1),
(30, 2, 'Press de Banco', 1),
(31, 2, 'Press Militar', 1),
(32, 2, 'Remo acostado', 1),
(33, 2, 'Remo al Mentón', 1),
(34, 2, 'Sentadilla', 1),
(35, 2, 'Test Dinámicos', 0),
(36, 2, 'Arranque', 1),
(37, 2, 'Cargada', 1),
(38, 2, 'Envión', 1),
(39, 2, 'Otros Test de Fuerza', 1),
(40, 2, 'Abdominales 1 min.', 1),
(41, 2, 'Absominales 30 seg.', 1),
(42, 2, 'Balón Medicinal 3 Kg.', 1),
(43, 2, 'Presión de Mano', 1),
(44, 2, 'Salto Horizontal', 1),
(45, 2, 'Salto Vertical', 1),
(46, 3, '12 Mts.', 1),
(47, 3, '30 Mts. (Partida Detenida)', 1),
(48, 3, '30 Mts. (Partida Lanzada)', 1),
(49, 3, '40 Mts.', 1),
(50, 3, '50 Mts.', 1),
(51, 3, '60 Mts. (Partida Detenida)', 1),
(52, 3, '60 Mts. (Partida Lanzada)', 1),
(53, 3, '90 Mts. (Partida Detenida)', 1),
(54, 3, '100 Mts. Llanos', 1),
(55, 3, '110 Mts Vallas', 1),
(56, 3, '200 Mts. Llanos', 1),
(57, 3, '300 Mts. Llanos', 1),
(58, 3, 'Relevo 4 x 100', 1),
(59, 3, 'Test de Letwin', 1),
(60, 4, 'Saltos Simples', 0),
(61, 4, 'Abalakov (ABK)', 1),
(62, 4, 'Squat Jump (SJ)', 1),
(63, 4, 'Squat Jump (SJ) con Carga', 1),
(64, 4, 'Couter Movement Jump (CMJ)', 1),
(65, 4, 'Couter Movement Jump (CMJ) con Carga', 1),
(66, 4, NULL, 1),
(67, 4, 'Drow Jump', NULL),
(68, 4, 'Máximo (Ambos Pies)', 1),
(69, 4, 'Máximo (Pie Derecho)', 1),
(70, 4, 'Máximo (Pie izquierdo)', 1),
(71, 4, 'Saltos Continuos', 0),
(72, 4, 'Por Número de Saltos', 1),
(73, 4, 'Por Tiempo', 1),
(74, 4, 'Por Número de Saltos', 1),
(75, 4, 'Bounce (Stifness)', 1),
(76, 4, 'Con Pierna Derecha', 1),
(77, 4, 'Con Pierna Izquierda', 1),
(96, 5, 'Extensión en Paso de Valla', 1),
(97, 5, 'Flexión de Hombro', 1),
(98, 5, 'Flexión de Tronco (Plano Horizontal)', 1),
(99, 5, 'Flexión de Tronco (Plano Vertical)', 1),
(100, 5, 'Flexión Profunda del Tronco', 1),
(101, 5, 'Test de Ely', 1),
(102, 5, 'Test de Flop', 1),
(103, 5, 'Test de Ober', 1),
(104, 5, 'Spagat Frontal', 1),
(105, 5, 'Spagat Lateral', 1),
(106, 7, 'Test de Balanza', 1),
(107, 7, 'Test de la Barra de Equilibrio', 1),
(108, 6, 'Test de Lanzamiento a Diana', 1),
(109, 6, 'Test del Slalom con Balón', 1),
(110, 8, 'Test de la Carrera de Obstáculos', 1),
(111, 8, 'Test de los 10 por 5', 1),
(112, 8, 'Test de Barrow', 1),
(113, NULL, '400 Mts. Llanos\r\n400 Mts. Vallas\r\nRelevo 4 x 400\r\n400 Mts. Llanos\r\n400 Mts. Vallas\r\nRelevo 4 x 400\r\n400 Mts. Llanos\r\n400 Mts. Vallas\r\nRelevo 4 x 400\r\n400 Mts. Llanos\r\n400 Mts. Vallas\r\nRelevo 4 x 400\r\n', 0);

-- --------------------------------------------------------

--
-- Estructura de tabla para la tabla `list_test_childs`
--

DROP TABLE IF EXISTS `list_test_childs`;
CREATE TABLE IF NOT EXISTS `list_test_childs` (
  `codtest_child` int(11) NOT NULL AUTO_INCREMENT,
  `codtest_parent` int(11) DEFAULT NULL,
  `codcapacity` int(11) DEFAULT NULL,
  `name` varchar(255) COLLATE utf8_spanish_ci DEFAULT NULL,
  PRIMARY KEY (`codtest_child`)
) ENGINE=MyISAM  DEFAULT CHARSET=utf8 COLLATE=utf8_spanish_ci AUTO_INCREMENT=73 ;

--
-- Volcar la base de datos para la tabla `list_test_childs`
--

INSERT INTO `list_test_childs` (`codtest_child`, `codtest_parent`, `codcapacity`, `name`) VALUES
(1, NULL, 3, '200 Mts. Llanos'),
(2, NULL, 3, '300 Mts. Llanos'),
(3, NULL, 3, 'Relevo 4 x 100'),
(4, NULL, 3, 'Test de Letwin'),
(5, NULL, 3, '110 Mts Vallas'),
(6, NULL, 3, '100 Mts. Llanos'),
(7, NULL, 3, '90 Mts. (Partida Detenida)'),
(8, NULL, 3, '60 Mts. (Partida Lanzada)'),
(9, NULL, 2, 'Salto Horizontal'),
(10, NULL, 2, 'Salto Vertical'),
(11, NULL, 3, '12 Mts.'),
(12, NULL, 3, '30 Mts. (Partida Detenida)'),
(13, NULL, 3, '30 Mts. (Partida Lanzada)'),
(14, NULL, 3, '40 Mts.'),
(15, NULL, 3, '50 Mts.'),
(16, NULL, 3, '60 Mts. (Partida Detenida)'),
(17, NULL, 2, 'Presión de Mano'),
(18, NULL, 4, 'Rocket Jump'),
(19, NULL, 4, 'Por Tiempo'),
(20, NULL, 4, 'Por Número de Saltos'),
(21, NULL, 4, 'Bounce (Stifness)'),
(22, NULL, 4, 'Con Pierna Derecha'),
(23, NULL, 4, 'Con Pierna Izquierda'),
(24, NULL, 5, 'Extensión en Paso de Valla'),
(25, NULL, 5, 'Flexión de Hombro'),
(26, NULL, 5, 'Flexión de Tronco (Plano Horizontal)'),
(27, NULL, 4, 'Por Número de Saltos'),
(28, NULL, 4, 'Abalakov (ABK)'),
(29, NULL, 4, 'Squat Jump (SJ)'),
(30, NULL, 4, 'Squat Jump (SJ) con Carga'),
(31, NULL, 4, 'Couter Movement Jump (CMJ)'),
(32, NULL, 4, 'Couter Movement Jump (CMJ) con Carga'),
(33, NULL, 4, 'Drow Jump'),
(34, NULL, 4, 'Máximo (Ambos Pies)'),
(35, NULL, 4, 'Máximo (Pie Derecho)'),
(36, NULL, 4, 'Máximo (Pie izquierdo)'),
(37, NULL, 5, 'Flexión de Tronco (Plano Vertical)'),
(38, NULL, 2, 'Balón Medicinal 3 Kg.'),
(39, NULL, 3, '200 Mts. Llanos'),
(40, NULL, 3, '300 Mts. Llanos'),
(41, NULL, 3, 'Relevo 4 x 100'),
(42, NULL, 3, 'Test de Letwin'),
(43, NULL, 3, '110 Mts Vallas'),
(44, NULL, 3, '100 Mts. Llanos'),
(45, NULL, 3, '90 Mts. (Partida Detenida)'),
(46, NULL, 3, '60 Mts. (Partida Lanzada)'),
(47, NULL, 2, 'Salto Horizontal'),
(48, NULL, 2, 'Salto Vertical'),
(49, NULL, 3, '12 Mts.'),
(50, NULL, 3, '30 Mts. (Partida Detenida)'),
(51, NULL, 3, '30 Mts. (Partida Lanzada)'),
(52, NULL, 3, '40 Mts.'),
(53, NULL, 3, '50 Mts.'),
(54, NULL, 3, '60 Mts. (Partida Detenida)'),
(55, NULL, 2, 'Presión de Mano'),
(56, NULL, 4, NULL),
(57, NULL, 4, 'Por Tiempo'),
(58, NULL, 4, 'Por Número de Saltos'),
(59, NULL, 4, 'Bounce (Stifness)'),
(60, NULL, 4, 'Con Pierna Derecha'),
(61, NULL, 4, 'Con Pierna Izquierda'),
(62, NULL, 5, 'Extensión en Paso de Valla'),
(63, NULL, 5, 'Flexión de Hombro'),
(64, NULL, 5, 'Flexión de Tronco (Plano Horizontal)'),
(65, NULL, 4, 'Por Número de Saltos'),
(66, NULL, 4, 'Abalakov (ABK)'),
(67, NULL, 4, 'Squat Jump (SJ)'),
(68, NULL, 4, 'Squat Jump (SJ) con Carga'),
(69, NULL, 4, 'Couter Movement Jump (CMJ)'),
(70, NULL, 4, 'Couter Movement Jump (CMJ) con Carga'),
(71, NULL, 4, 'Drow Jump'),
(72, NULL, 4, 'Máximo (Ambos Pies)');
...
INSERT INTO `login` (`codlogin`, `coduser`, `date_time`, `ip`, `browser`, `sessionid`) VALUES
(183, 23, '2009-11-04 12:53:58', '192.168.0.100', 'Mozilla/5.0 (Windows; U; Windows NT 5.1; es-AR; rv:1.9.1.4) Gecko/20091016 Firefox/3.5.4', '0891c3fc52def6b54ba998f4a6afbce4'),
(207, 22, '2010-02-19 12:44:49', '::1', 'Mozilla/5.0 (X11; U; Linux i686; es-AR; rv:1.9.1.6) Gecko/20091215 Ubuntu/9.10 (karmic) Firefox/3.5.', 'ici7nmrtkklbs4386ko9hmk3h2'),
(197, 26, '2009-11-23 13:30:44', '192.168.0.2', 'Mozilla/5.0 (Windows; U; Windows NT 5.1; es-ES; rv:1.9.1.5) Gecko/20091102 Firefox/3.5.5', '816bec14f0a8aa767f18c73a4b1849d1'),
(203, 29, '2009-12-07 21:16:15', '192.168.0.2', 'Mozilla/5.0 (Windows; U; Windows NT 5.1; es-ES; rv:1.9.1.5) Gecko/20091102 Firefox/3.5.5', '2360523a4c3adc23e11b908b5ec67204');
...
CREATE TABLE IF NOT EXISTS `movies` (
  `codmovie` int(11) NOT NULL AUTO_INCREMENT,
  `coduser` int(11) DEFAULT NULL,
  `filename` varchar(250) COLLATE utf8_spanish_ci DEFAULT NULL,
  `filesize` double DEFAULT NULL COMMENT 'Expresado byte',
  PRIMARY KEY (`codmovie`)
...
--
-- Estructura de tabla para la tabla `profilesport_to_country`
--

DROP TABLE IF EXISTS `profilesport_to_country`;
CREATE TABLE IF NOT EXISTS `profilesport_to_country` (
  `id` int(11) NOT NULL AUTO_INCREMENT,
  `codprofsport` int(11) DEFAULT NULL,
  `codcountry` int(11) DEFAULT NULL,
  PRIMARY KEY (`id`)
) ENGINE=MyISAM  DEFAULT CHARSET=utf8 COLLATE=utf8_spanish_ci AUTO_INCREMENT=65 ;

--
-- Volcar la base de datos para la tabla `profilesport_to_country`
--

INSERT INTO `profilesport_to_country` (`id`, `codprofsport`, `codcountry`) VALUES
(64, 13, 6),
(63, 13, 5),
(62, 13, 4),
(61, 13, 3),
...
--
-- Estructura de tabla para la tabla `profile_sport`
--

DROP TABLE IF EXISTS `profile_sport`;
CREATE TABLE IF NOT EXISTS `profile_sport` (
  `codprofsport` int(11) NOT NULL AUTO_INCREMENT,
  `coduser` int(11) DEFAULT NULL,
  `codsport` int(11) DEFAULT NULL COMMENT 'list_sports:codsport',
  `level` int(1) DEFAULT NULL COMMENT '1=Profesional,2=Aficionado,3=Amateur',
  `leg_habil` int(1) DEFAULT NULL COMMENT 'Pierna habil:1=Derecha,2=Izquierda',
  `hand_habil` int(1) DEFAULT NULL COMMENT 'Mano habil:1=Derecha,2=Izquierda',
  `pase` int(1) DEFAULT NULL COMMENT '1=me pertenece,2=mi club de origen,3=mi club actual,4=mi representante',
  `pase_description` varchar(255) COLLATE utf8_spanish_ci DEFAULT NULL COMMENT 'Descripcion del pase',
  `codposition` int(11) DEFAULT NULL,
  `codpositionavanzada` int(11) DEFAULT NULL,
  `alc_bloqueo` varchar(50) CHARACTER SET utf8 DEFAULT NULL,
  `alc_ataque` varchar(50) CHARACTER SET utf8 DEFAULT NULL,
  `alc_parado` varchar(50) CHARACTER SET utf8 DEFAULT NULL,
  `codbestshot` varchar(255) CHARACTER SET utf8 DEFAULT NULL COMMENT 'list_best_shot:code',
  `other_bestshot` varchar(255) COLLATE utf8_spanish_ci DEFAULT NULL COMMENT 'Otro mejor golpe',
  `ent_fisico` int(11) DEFAULT NULL COMMENT 'Tiempo expresado en horas.',
  `ent_gim` int(11) DEFAULT NULL COMMENT 'Tiempo expresado en horas.',
  `ent_tactico` int(11) DEFAULT NULL COMMENT 'Tiempo expresado en horas.',
  `ent_tecnico` int(11) DEFAULT NULL COMMENT 'Tiempo expresado en horas.',
  `codsel` int(11) DEFAULT NULL COMMENT 'list_selected:codsel',
  `other_sel` varchar(255) COLLATE utf8_spanish_ci DEFAULT NULL COMMENT 'Otro Seleccionado',
  `codability` int(11) DEFAULT NULL COMMENT 'list_greater_ability:codability',
  `other_ability` varchar(50) COLLATE utf8_spanish_ci DEFAULT NULL COMMENT 'Otra habilidad',
  `available_resources` varchar(50) COLLATE utf8_spanish_ci DEFAULT NULL COMMENT 'Slapper,Toques,Amagues de Toques y Bateo...,otras',
  `codmod` int(11) DEFAULT NULL COMMENT 'list_modality:codmod',
  `other_mod` varchar(255) COLLATE utf8_spanish_ci DEFAULT NULL COMMENT 'Otra Modalidad',
  `rank_int` int(11) DEFAULT NULL COMMENT 'Ranking en numero.',
  `rank_nac` int(11) DEFAULT NULL COMMENT 'Ranking en numero.',
  `rank_nombre` varchar(255) CHARACTER SET utf8 DEFAULT NULL COMMENT 'Nombre del Ranking',
  `rank_nombre_num` int(11) DEFAULT NULL COMMENT 'Numero Ranking',
  `codcategory` int(11) DEFAULT NULL COMMENT 'list_category:codcategory',
  `other_category` varchar(255) COLLATE utf8_spanish_ci DEFAULT NULL COMMENT 'Otra Categoría',
  `international_debut` int(11) DEFAULT NULL COMMENT 'Fecha del Debut.',
  `alcance` int(11) DEFAULT NULL COMMENT 'Expresado en metros.',
  `years_playing` int(11) DEFAULT NULL COMMENT 'Años Jugando',
  `prof_desde` int(11) DEFAULT NULL COMMENT 'Año',
  `gainings` int(11) DEFAULT NULL COMMENT 'Expresadas en USS',
  `playing_from` int(11) DEFAULT NULL COMMENT 'Jugando desde.',
  `playing_up` int(11) DEFAULT NULL COMMENT 'Jugando hasta',
  `primera_liga_debut` int(11) DEFAULT NULL COMMENT 'Fecha del Debut',
  `speciality` varchar(50) COLLATE utf8_spanish_ci DEFAULT NULL COMMENT 'BMX, BMX Supercross,Ciclo-cross,otra',
  `other_speciality` varchar(255) COLLATE utf8_spanish_ci DEFAULT NULL COMMENT 'Otra especialidad',
  `discipline` varchar(50) COLLATE utf8_spanish_ci DEFAULT NULL COMMENT '100 Mts. Llanos,110 Mts. Vallas...',
  `other_discipline` varchar(60) COLLATE utf8_spanish_ci DEFAULT NULL,
  `position_court` varchar(50) COLLATE utf8_spanish_ci DEFAULT NULL COMMENT 'Drive, Revés',
  `pala` varchar(50) COLLATE utf8_spanish_ci DEFAULT NULL COMMENT 'Marca de la Paleta',
  `partner` varchar(50) COLLATE utf8_spanish_ci DEFAULT NULL COMMENT 'Compañero de tenis',
  `swimming_from` int(11) DEFAULT NULL,
  `current_coach` varchar(50) COLLATE utf8_spanish_ci DEFAULT NULL COMMENT 'Entrenado Actual',
  `years_climbing` int(11) DEFAULT NULL COMMENT 'Años escalando',
  `license` varchar(50) COLLATE utf8_spanish_ci DEFAULT NULL COMMENT 'Licencia del Boxeador',
  `experience_abroad` int(1) DEFAULT NULL COMMENT 'list_country:codcountry, null=No tiene experiencia en el exterior',
  `affliction` varchar(255) COLLATE utf8_spanish_ci DEFAULT NULL COMMENT 'Enfermedad',
  `description_affliction` varchar(60) COLLATE utf8_spanish_ci DEFAULT NULL,
  `codope` varchar(255) CHARACTER SET utf8 DEFAULT NULL COMMENT 'Operaciones',
  `other_operation` varchar(60) COLLATE utf8_spanish_ci DEFAULT NULL,
  `representative` varchar(255) COLLATE utf8_spanish_ci DEFAULT NULL COMMENT 'Representante',
  `professional_objective` varchar(255) COLLATE utf8_spanish_ci DEFAULT NULL COMMENT 'Objetivo Profesional',
  PRIMARY KEY (`codprofsport`)
) ENGINE=MyISAM  DEFAULT CHARSET=utf8 COLLATE=utf8_spanish_ci AUTO_INCREMENT=14 ;

--
-- Volcar la base de datos para la tabla `profile_sport`
--

INSERT INTO `profile_sport` (`codprofsport`, `coduser`, `codsport`, `level`, `leg_habil`, `hand_habil`, `pase`, `pase_description`, `codposition`, `codpositionavanzada`, `alc_bloqueo`, `alc_ataque`, `alc_parado`, `codbestshot`, `other_bestshot`, `ent_fisico`, `ent_gim`, `ent_tactico`, `ent_tecnico`, `codsel`, `other_sel`, `codability`, `other_ability`, `available_resources`, `codmod`, `other_mod`, `rank_int`, `rank_nac`, `rank_nombre`, `rank_nombre_num`, `codcategory`, `other_category`, `international_debut`, `alcance`, `years_playing`, `prof_desde`, `gainings`, `playing_from`, `playing_up`, `primera_liga_debut`, `speciality`, `other_speciality`, `discipline`, `other_discipline`, `position_court`, `pala`, `partner`, `swimming_from`, `current_coach`, `years_climbing`, `license`, `experience_abroad`, `affliction`, `description_affliction`, `codope`, `other_operation`, `representative`, `professional_objective`) VALUES
(13, 22, 16, 2, NULL, NULL, NULL, '', NULL, NULL, '', '', '', NULL, '', NULL, NULL, NULL, NULL, NULL, '', NULL, '', NULL, NULL, '', 5, 5, 'El ranking', 5, 33, '', NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, '16', '', NULL, '', '', '', '', 0, '', NULL, 'A', 1, NULL, NULL, '16', '', 'El Representante', 'Terminar Modificar\niuyÃ±Ã±Ã h');
...
CREATE TABLE IF NOT EXISTS `users` (
  ...
  `pass` char(32) COLLATE utf8_spanish_ci DEFAULT NULL,
  `newsletters` int(1) DEFAULT NULL,
  `active` int(1) DEFAULT '0',
  `id` char(32) COLLATE utf8_spanish_ci DEFAULT NULL,
  `tableuser` char(21) COLLATE utf8_spanish_ci DEFAULT NULL,
  PRIMARY KEY (`coduser`)
...
INSERT INTO `users` (`coduser`, `email`, `pass`, `newsletters`, `active`, `id`, `tableuser`) VALUES
(22, 'sport@gmail.com', 'e99a18c428cb38d5f260853678922e03', 0, 1, NULL, 'users_sports'),
(23, 'repr@gmail.com', 'e99a18c428cb38d5f260853678922e03', 1, 1, '37693cfc748049e45d87b8c7d8b9aacd', 'users_representatives'),
(26, 'club@gmail.com', 'e99a18c428cb38d5f260853678922e03', 1, 1, '4e732ced3463d06de0ca9a15b6153677', 'users_club'),
(29, 'sponsor@gmail.com', 'e99a18c428cb38d5f260853678922e03', 1, 1, '6ea9ab1baa0efb9e19094440c317e21b', 'users_sponsors'),
(32, 'sport2@gmail.com', '97beb9cb74c7526931a121608d8bdc13', 1, 1, '6364d3f0f495b6ab9dcf8d3b5c6e0b01', 'users_sports');
...
CREATE TABLE IF NOT EXISTS `users_club` (
  `codclub` int(11) NOT NULL AUTO_INCREMENT,
  `coduser` int(11) DEFAULT NULL,
  `business_name` char(80) COLLATE utf8_spanish_ci DEFAULT NULL,
  `cuit` char(15) COLLATE utf8_spanish_ci DEFAULT NULL,
  `fundation_years` int(4) DEFAULT NULL,
  `president` char(50) COLLATE utf8_spanish_ci DEFAULT NULL,
  `name_stadium` char(50) COLLATE utf8_spanish_ci DEFAULT NULL,
  `addresse_sede` varchar(255) COLLATE utf8_spanish_ci DEFAULT NULL,
  `country` int(11) DEFAULT NULL,
  `province` int(11) DEFAULT NULL,
  `city` varchar(255) COLLATE utf8_spanish_ci DEFAULT NULL,
  `cp` int(6) DEFAULT NULL,
  `phone_pref1` int(6) DEFAULT NULL COMMENT 'prefijo pais',
  `phone_pref2` int(6) DEFAULT NULL COMMENT 'prefijo ciudad',
  `phone` int(11) DEFAULT NULL,
  `cel_pref1` int(6) DEFAULT NULL,
  `cel_pref2` int(6) DEFAULT NULL,
  `cel` int(11) DEFAULT NULL,
  `competition_category` varchar(255) COLLATE utf8_spanish_ci DEFAULT NULL,
  `competition_new_category` varchar(255) COLLATE utf8_spanish_ci DEFAULT NULL,
  `titular_lastname` char(50) COLLATE utf8_spanish_ci DEFAULT NULL,
  `titular_firstname` char(50) COLLATE utf8_spanish_ci DEFAULT NULL,
  `titular_charge` char(100) COLLATE utf8_spanish_ci DEFAULT NULL,
  `titular_phone_pref1` int(6) DEFAULT NULL COMMENT 'prefijo pais',
  `titular_phone_pref2` int(6) DEFAULT NULL COMMENT 'prefijo ciudad',
  `titular_phone` varchar(255) COLLATE utf8_spanish_ci DEFAULT NULL,
  `titular_cel_pref1` int(6) DEFAULT NULL,
  `titular_cel_pref2` int(6) DEFAULT NULL,
  `titular_cel` int(11) DEFAULT NULL,
  `titular_typedoc` varchar(255) COLLATE utf8_spanish_ci DEFAULT NULL,
  `titular_typedoc_new` varchar(255) COLLATE utf8_spanish_ci DEFAULT NULL,
  `titular_nrodoc` char(20) COLLATE utf8_spanish_ci DEFAULT NULL,
  PRIMARY KEY (`codclub`)
...
INSERT INTO `users_club` (`codclub`, `coduser`, `business_name`, `cuit`, `fundation_years`, `president`, `name_stadium`, `addresse_sede`, `country`, `province`, `city`, `cp`, `phone_pref1`, `phone_pref2`, `phone`, `cel_pref1`, `cel_pref2`, `cel`, `competition_category`, `competition_new_category`, `titular_lastname`, `titular_firstname`, `titular_charge`, `titular_phone_pref1`, `titular_phone_pref2`, `titular_phone`, `titular_cel_pref1`, `titular_cel_pref2`, `titular_cel`, `titular_typedoc`, `titular_typedoc_new`, `titular_nrodoc`) VALUES
(6, 26, 'MyDesign', '20.30536404.06', 2009, 'Sdfsdf', 'sdfsdf', 'aksjdfla sdf as fs df', 13, 180, 'Mendoza', 5500, 121, 441, 4442192, 1221, 554, 44421, ' Profesional', 'fsdfsdf', 'Mattoni', 'Ivan', 'asdadasd', 121, 121, '4444', 2112, 2112, 45, 'DNI', '', '2445');

-- --------------------------------------------------------

--
-- Estructura de tabla para la tabla `users_club_to_sport`
--

DROP TABLE IF EXISTS `users_club_to_sport`;
CREATE TABLE IF NOT EXISTS `users_club_to_sport` (
  `id` int(11) NOT NULL AUTO_INCREMENT,
  `codclub` int(11) NOT NULL DEFAULT '0',
  `codsport` int(11) NOT NULL DEFAULT '0',
  PRIMARY KEY (`id`)
) ENGINE=MyISAM  DEFAULT CHARSET=utf8 COLLATE=utf8_spanish_ci AUTO_INCREMENT=22 ;

--
-- Volcar la base de datos para la tabla `users_club_to_sport`
--

INSERT INTO `users_club_to_sport` (`id`, `codclub`, `codsport`) VALUES
(12, 6, 27),
(11, 6, 32),
(10, 6, 28),
(13, 6, 37),
...
--
-- Estructura de tabla para la tabla `users_representatives`
--

DROP TABLE IF EXISTS `users_representatives`;
CREATE TABLE IF NOT EXISTS `users_representatives` (
  `codrepr` int(11) NOT NULL AUTO_INCREMENT,
  `coduser` int(11) DEFAULT NULL,
  `lastname` char(50) COLLATE utf8_spanish_ci DEFAULT NULL,
  `firstname` char(50) COLLATE utf8_spanish_ci DEFAULT NULL,
  `sex` int(1) DEFAULT NULL COMMENT '1=Masculino, 2=Femenino',
  `birth` char(10) COLLATE utf8_spanish_ci DEFAULT NULL,
  `typedoc` varchar(255) COLLATE utf8_spanish_ci DEFAULT NULL,
  `typedoc_new` varchar(255) COLLATE utf8_spanish_ci DEFAULT NULL,
  `nrodoc` char(20) COLLATE utf8_spanish_ci DEFAULT NULL,
  `country` int(11) DEFAULT NULL,
  `province` int(11) DEFAULT NULL,
  `city` char(50) COLLATE utf8_spanish_ci DEFAULT NULL,
  `cp` int(6) DEFAULT NULL COMMENT 'codigo postal',
  `nacionality` char(100) COLLATE utf8_spanish_ci DEFAULT NULL,
  `nacionality2` char(100) COLLATE utf8_spanish_ci DEFAULT NULL,
  `nacionality3` char(100) COLLATE utf8_spanish_ci DEFAULT NULL,
  `passport` int(1) DEFAULT NULL COMMENT '0=sin pasaporte, 1=comunitario, 2=extracomunitario',
  `phone_pref1` int(6) DEFAULT NULL COMMENT 'prefijo pais',
  `phone_pref2` int(6) DEFAULT NULL COMMENT 'prefijo ciudad',
  `phone` int(11) DEFAULT NULL,
  `cel_pref1` int(6) DEFAULT NULL COMMENT 'prefijo pais',
  `cel_pref2` int(6) DEFAULT NULL COMMENT 'prefijo ciudad',
  `cel` int(11) DEFAULT NULL COMMENT 'numero de celular',
  `website` varchar(255) COLLATE utf8_spanish_ci DEFAULT NULL,
  `profession` varchar(255) COLLATE utf8_spanish_ci DEFAULT NULL,
  `work` varchar(255) COLLATE utf8_spanish_ci DEFAULT NULL,
  `work_new` varchar(255) COLLATE utf8_spanish_ci DEFAULT NULL,
  `licence_nro` char(100) COLLATE utf8_spanish_ci DEFAULT NULL,
  `level` int(1) DEFAULT NULL COMMENT '1=Profesional, 2=Amateur, 3=Ambos',
  `language` int(11) DEFAULT NULL,
  `language_level_write` int(1) DEFAULT NULL COMMENT '1=Basico, 2=Intermedio, 3=Avanzado',
  `language_level_talk` int(1) DEFAULT NULL COMMENT '1=Basico, 2=Intermedio, 3=Avanzado',
  `language2` int(11) DEFAULT NULL,
  `language2_level_write` int(1) DEFAULT NULL COMMENT '1=Basico, 2=Intermedio, 3=Avanzado',
  `language2_level_talk` int(1) DEFAULT NULL COMMENT '1=Basico, 2=Intermedio, 3=Avanzado',
  `language3` int(11) DEFAULT NULL,
  `language3_level_write` int(1) DEFAULT NULL COMMENT '1=Basico, 2=Intermedio, 3=Avanzado',
  `language3_level_talk` int(1) DEFAULT NULL COMMENT '1=Basico, 2=Intermedio, 3=Avanzado',
  `language4` int(11) DEFAULT NULL,
  `language4_level_write` int(1) DEFAULT NULL COMMENT '1=Basico, 2=Intermedio, 3=Avanzado',
  `language4_level_talk` int(1) DEFAULT NULL COMMENT '1=Basico, 2=Intermedio, 3=Avanzado',
  `codimage` int(11) DEFAULT NULL,
  PRIMARY KEY (`codrepr`)
) ENGINE=MyISAM  DEFAULT CHARSET=utf8 COLLATE=utf8_spanish_ci AUTO_INCREMENT=3 ;

--
-- Volcar la base de datos para la tabla `users_representatives`
--

INSERT INTO `users_representatives` (`codrepr`, `coduser`, `lastname`, `firstname`, `sex`, `birth`, `typedoc`, `typedoc_new`, `nrodoc`, `country`, `province`, `city`, `cp`, `nacionality`, `nacionality2`, `nacionality3`, `passport`, `phone_pref1`, `phone_pref2`, `phone`, `cel_pref1`, `cel_pref2`, `cel`, `website`, `profession`, `work`, `work_new`, `licence_nro`, `level`, `language`, `language_level_write`, `language_level_talk`, `language2`, `language2_level_write`, `language2_level_talk`, `language3`, `language3_level_write`, `language3_level_talk`, `language4`, `language4_level_write`, `language4_level_talk`, `codimage`) VALUES
(2, 23, 'Mattoni', 'Ivan', 1, '03/12/1983', 'DNI', '', '30536404', 13, 180, 'Mendoza', 5500, 'argentino', '', '', 2, 3434, 3434, 4442192, 422, 5454, 44421454, 'http://mydesign.com.ar', 'asdasdasd', 'Independiente', '', 'dfsdfsdf', 1, 22, 3, 3, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL);

-- --------------------------------------------------------

--
-- Estructura de tabla para la tabla `users_representatives_to_sport`
--

DROP TABLE IF EXISTS `users_representatives_to_sport`;
CREATE TABLE IF NOT EXISTS `users_representatives_to_sport` (
  `id` int(11) NOT NULL AUTO_INCREMENT,
  `codrepr` int(11) DEFAULT NULL,
  `codsport` int(11) DEFAULT NULL,
  PRIMARY KEY (`id`)
) ENGINE=MyISAM  DEFAULT CHARSET=utf8 COLLATE=utf8_spanish_ci AUTO_INCREMENT=24 ;

--
-- Volcar la base de datos para la tabla `users_representatives_to_sport`
--

INSERT INTO `users_representatives_to_sport` (`id`, `codrepr`, `codsport`) VALUES
(23, 2, 8),
(22, 2, 6);
...
CREATE TABLE IF NOT EXISTS `users_sponsors` (
  `codsponsor` int(11) NOT NULL AUTO_INCREMENT,
  `coduser` int(11) DEFAULT NULL,
  `business_name` varchar(255) COLLATE utf8_spanish_ci DEFAULT NULL,
  `cuit` char(15) COLLATE utf8_spanish_ci DEFAULT NULL,
  ...
  `cel_pref2` int(6) DEFAULT NULL COMMENT 'prefijo ciudad',
  `cel` int(11) DEFAULT NULL,
  `codcompanylist` int(11) DEFAULT NULL,
  `titular_lastname` char(50) COLLATE utf8_spanish_ci DEFAULT NULL,
  `titular_firstname` char(50) COLLATE utf8_spanish_ci DEFAULT NULL,
  `titular_charge` char(100) COLLATE utf8_spanish_ci DEFAULT NULL,
  `titular_phone_pref1` int(6) DEFAULT NULL COMMENT 'prefijo pais',
  `titular_phone_pref2` int(6) DEFAULT NULL COMMENT 'prefijo ciudad',
  `titular_phone` int(11) DEFAULT NULL,
  `titular_cel_pref1` int(6) DEFAULT NULL COMMENT 'prefijo pais',
  `titular_cel_pref2` int(6) DEFAULT NULL COMMENT 'prefijo ciudad',
  `titular_cel` int(11) DEFAULT NULL,
  `titular_typedoc` varchar(255) COLLATE utf8_spanish_ci DEFAULT NULL,
  `titular_typedoc_new` varchar(255) COLLATE utf8_spanish_ci DEFAULT NULL,
  `titular_nrodoc` char(20) COLLATE utf8_spanish_ci DEFAULT NULL,
...
--
-- Estructura de tabla para la tabla `users_sports`
--
...
CREATE TABLE IF NOT EXISTS `users_sports` (
  ...
  `typedoc` varchar(255) COLLATE utf8_spanish_ci DEFAULT NULL,
  `typedoc_new` varchar(255) COLLATE utf8_spanish_ci DEFAULT NULL,
  `nrodoc` char(40) CHARACTER SET utf8 DEFAULT NULL,
  `country` int(11) DEFAULT NULL,
  `province` int(11) DEFAULT NULL,
  `city` char(50) COLLATE utf8_spanish_ci DEFAULT NULL,
  `cp` int(6) DEFAULT NULL COMMENT 'Codigo postal',
  ...
  `nacionality2` char(100) COLLATE utf8_spanish_ci DEFAULT NULL,
  `nacionality3` char(100) COLLATE utf8_spanish_ci DEFAULT NULL,
  `passport` int(1) DEFAULT NULL COMMENT '1=sin pasaporte, 2=comunitario, 3=extracomunitario',
  `phone_pref1` int(6) DEFAULT NULL COMMENT 'prefijo pais',
  `phone_pref2` int(6) DEFAULT NULL COMMENT 'prefijo ciudad',
  `phone` int(11) DEFAULT NULL COMMENT 'numero telefono',
  `cel_pref1` int(6) DEFAULT NULL COMMENT 'prefijo pais',
  `cel_pref2` int(6) DEFAULT NULL COMMENT 'prefijo ciudad',
  `cel` int(11) DEFAULT NULL COMMENT 'numero celular',
  `website` varchar(255) COLLATE utf8_spanish_ci DEFAULT NULL,
  `language` int(11) DEFAULT NULL,
  `language_level_write` int(1) DEFAULT NULL COMMENT '1=Basico, 2=Intermedio, 3=Avanzado',
  `language_level_talk` int(1) DEFAULT NULL COMMENT '1=Basico, 2=Intermedio, 3=Avanzado',
  ...
  `language4_level_talk` int(1) DEFAULT NULL COMMENT '1=Basico, 2=Intermedio, 3=Avanzado',
  `profession` varchar(255) COLLATE utf8_spanish_ci DEFAULT NULL,
  `studies` varchar(255) COLLATE utf8_spanish_ci DEFAULT NULL,
  `disability` int(1) DEFAULT NULL COMMENT '1= con discapacidad, 0=sin discapacidad',
  `typedisc` int(1) DEFAULT NULL COMMENT '1=Motora, 2=Sensorial, 3=Mental, 4=Visceral',
  `detaildisc` varchar(255) COLLATE utf8_spanish_ci DEFAULT NULL,
  `codimage` int(11) DEFAULT NULL,
  PRIMARY KEY (`codsport`)
) ENGINE=MyISAM  DEFAULT CHARSET=utf8 COLLATE=utf8_spanish_ci AUTO_INCREMENT=11 ;

--
-- Volcar la base de datos para la tabla `users_sports`
--

INSERT INTO `users_sports` (`codsport`, `coduser`, `lastname`, `firstname`, `sex`, `birth`, `typedoc`, `typedoc_new`, `nrodoc`, `country`, `province`, `city`, `cp`, `nacionality`, `nacionality2`, `nacionality3`, `passport`, `phone_pref1`, `phone_pref2`, `phone`, `cel_pref1`, `cel_pref2`, `cel`, `website`, `language`, `language_level_write`, `language_level_talk`, `language2`, `language2_level_write`, `language2_level_talk`, `language3`, `language3_level_write`, `language3_level_talk`, `language4`, `language4_level_write`, `language4_level_talk`, `profession`, `studies`, `disability`, `typedisc`, `detaildisc`, `codimage`) VALUES
(9, 22, 'Mattoni', 'Ivan', 1, '03/09/1945', 'DNI', '', '45345345', 13, 180, 'Dfgdfg', 5500, 'argentino', 'aa', 'bb', 2, 232, 343, 4442192, 34, 34, 123233, 'http://fvbfgfg', 75, 2, 2, 22, 3, 3, NULL, NULL, NULL, NULL, NULL, NULL, 'tttttt', 'ghfgh', 1, 1, 'gghgh', 1),
(10, 32, 'Mattoni', 'Ivan', 1, '02/12/1983', 'DNI', '', '30536404', 13, 180, 'Mendoza', 5500, 'argentino', '', '', 1, 45, 21, 545454, 121, 54, 45454, '', NULL, 1, 1, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, '', '', 0, 1, '', NULL);
